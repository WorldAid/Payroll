...
import {
  ...
  vi,
  yParityToV
} from "./chunk-PUBYE4YW.js";
import {
  bootstrapLazy
} from "./chunk-JQFRS35J.js";
import {
  BaseError,
  BaseError2,
  FeeCapTooHighError,
...
} from "./chunk-NFJK6YYE.js";
import {
  __commonJS,
  __export,
  __toESM
} from "./chunk-HELTYQYU.js";
...
var require_utils = __commonJS({
  "node_modules/@noble/hashes/utils.js"(exports) {
    ...
    var hexes6 = Array.from({ length: 256 }, (v2, i) => i.toString(16).padStart(2, "0"));
...
var require_sha256 = __commonJS({
  "node_modules/@noble/hashes/sha256.js"(exports) {
    ...
    var SHA2562 = class extends _sha2_js_1.SHA2 {
      ...
      get() {
        const { A, B: B2, C, D, E: E2, F: F2, G: G3, H: H2 } = this;
        return [A, B2, C, D, E2, F2, G3, H2];
      }
      // prettier-ignore
      set(A, B2, C, D, E2, F2, G3, H2) {
        this.A = A | 0;
        this.B = B2 | 0;
        this.C = C | 0;
        this.D = D | 0;
      ...
      process(view, offset) {
        ...
        let { A, B: B2, C, D, E: E2, F: F2, G: G3, H: H2 } = this;
        for (let i = 0; i < 64; i++) {
...
var require_address = __commonJS({
  "node_modules/c32check/lib/address.js"(exports) {
    ...
    function c32address8(version, hash160hex) {
    ...
    exports.c32address = c32address8;
    ...
    function b58ToC32(b58check, version = -1) {
      ...
      return c32address8(stacksVersion, hash160String);
    }
...
function createEnumChecker(enumVariable) {
  const enumValues = Object.values(enumVariable).filter((v2) => typeof v2 === "number");
...
var BytesReader = class {
  constructor(bytes2) {
    this.consumed = 0;
    this.source = typeof bytes2 === "string" ? hexToBytes2(bytes2) : bytes2;
  }
  readBytes(length) {
...
(function(ClarityVersion3) {
  ...
  ClarityVersion3[ClarityVersion3["Clarity4"] = 4] = "Clarity4";
...
(function(TenureChangeCause3) {
  TenureChangeCause3[TenureChangeCause3["BlockFound"] = 0] = "BlockFound";
  TenureChangeCause3[TenureChangeCause3["Extended"] = 1] = "Extended";
  TenureChangeCause3[TenureChangeCause3["ExtendedRuntime"] = 2] = "ExtendedRuntime";
  TenureChangeCause3[TenureChangeCause3["ExtendedReadCount"] = 3] = "ExtendedReadCount";
  TenureChangeCause3[TenureChangeCause3["ExtendedReadLength"] = 4] = "ExtendedReadLength";
  TenureChangeCause3[TenureChangeCause3["ExtendedWriteCount"] = 5] = "ExtendedWriteCount";
  TenureChangeCause3[TenureChangeCause3["ExtendedWriteLength"] = 6] = "ExtendedWriteLength";
})(TenureChangeCause || (TenureChangeCause = {}));
var AuthFieldType;
(function(AuthFieldType3) {
  AuthFieldType3[AuthFieldType3["PublicKeyCompressed"] = 0] = "PublicKeyCompressed";
  AuthFieldType3[AuthFieldType3["PublicKeyUncompressed"] = 1] = "PublicKeyUncompressed";
  AuthFieldType3[AuthFieldType3["SignatureCompressed"] = 2] = "SignatureCompressed";
  AuthFieldType3[AuthFieldType3["SignatureUncompressed"] = 3] = "SignatureUncompressed";
...
if (!isLE)
  throw new Error("Non little-endian hardware is not supported");
var hexes2 = Array.from({ length: 256 }, (v2, i) => i.toString(16).padStart(2, "0"));
...
var HMAC = class extends Hash {
  constructor(hash5, _key) {
    ...
    pad2.set(key.length > blockLen ? hash5.create().update(key).digest() : key);
...
var JacobianPoint = class _JacobianPoint {
  ...
  double() {
    ...
    const E2 = mod(_3n * A);
    const F2 = mod(E2 * E2);
    const X3 = mod(F2 - _2n * D);
    const Y3 = mod(E2 * (D - X3) - _8n * C);
  ...
  multiply(scalar, affinePoint) {
    ...
    if (USE_ENDOMORPHISM) {
      ...
      const { p: p2, f: f3 } = this.wNAF(n, affinePoint);
      point = p2;
      fake = f3;
    }
...
var Point = class _Point {
  ...
  toRawBytes(isCompressed2 = false) {
    return hexToBytes3(this.toHex(isCompressed2));
  }
...
var hexes3 = Array.from({ length: 256 }, (v2, i) => i.toString(16).padStart(2, "0"));
...
function numTo32b(num) {
  const b2 = hexToBytes3(numTo32bStr(num));
  if (b2.length !== 32)
...
function sqrtMod(x2) {
  ...
  const b2 = x2 * x2 * x2 % P;
  const b32 = b2 * b2 * x2 % P;
  const b6 = pow2(b32, _3n) * b32 % P;
  const b9 = pow2(b6, _3n) * b32 % P;
  ...
  const b223 = pow2(b220, _3n) * b32 % P;
...
function invert(number2, modulo = CURVE.P) {
  ...
  let b2 = modulo;
  let x2 = _0n, y2 = _1n, u = _1n, v2 = _0n;
  while (a !== _0n) {
    const q2 = b2 / a;
    const r = b2 % a;
    const m = x2 - u * q2;
...
function truncateHash(hash5, truncateOnly = false) {
  const h = bits2int_2(hash5);
  if (truncateOnly)
    return h;
  const { n } = CURVE;
  return h >= n ? h - n : h;
...
function initSigArgs(msgHash, privateKey, extraEntropy2) {
  if (msgHash == null)
  ...
  if (extraEntropy2 != null) {
    if (extraEntropy2 === true)
      extraEntropy2 = utils.randomBytes(fieldLen);
    const e2 = ensureBytes(extraEntropy2);
...
var utils = {
  ...
  hashToPrivateKey: (hash5) => {
    hash5 = ensureBytes(hash5);
    const minLen = groupLen + 8;
    if (hash5.length < minLen || hash5.length > 1024) {
      throw new Error(`Expected valid bytes of private key as per FIPS 186`);
    }
    const num = mod(bytesToNumber(hash5), CURVE.n - _1n) + _1n;
    return numTo32b(num);
  },
  ...
  sha256: async (...messages) => {
    if (crypto3.web) {
      ...
      const hash5 = createHash("sha256");
      messages.forEach((m) => hash5.update(m));
      return Uint8Array.from(hash5.digest());
    } else {
  ...
  hmacSha256: async (key, ...messages) => {
    if (crypto3.web) {
      ...
      const hash5 = createHmac("sha256", key);
      messages.forEach((m) => hash5.update(m));
      return Uint8Array.from(hash5.digest());
    } else {
...
var sha3842 = wrapConstructor(() => new SHA384());
...
function clarityTypeToByte(type2) {
  return ClarityWireType[type2];
}
...
var intCV = (value) => {
  if (typeof value === "string" && value.toLowerCase().startsWith("0x")) {
    value = bytesToTwosBigInt(hexToBytes2(value));
  }
  if (isInstance(value, Uint8Array))
...
function createMessageSignature(signature) {
  const length = hexToBytes2(signature).byteLength;
...
function serializeAddressBytes(address2) {
  const bytesArray = [];
  bytesArray.push(hexToBytes2(intToHex(address2.version, 1)));
  bytesArray.push(hexToBytes2(address2.hash160));
...
function serializeLPStringBytes(lps) {
  ...
  bytesArray.push(hexToBytes2(intToHex(length, lps.lengthPrefixBytes)));
...
function serializeMemoStringBytes(memoString) {
  ...
  bytesArray.push(hexToBytes2(paddedContent));
  return concatArray(bytesArray);
}
...
function serializeLPListBytes(lpList) {
  ...
  const bytesArray = [];
  bytesArray.push(hexToBytes2(intToHex(list2.length, lpList.lengthPrefixBytes)));
  for (const l of list2) {
    bytesArray.push(serializeStacksWireBytes(l));
  }
  return concatArray(bytesArray);
}
function deserializeLPList(serialized, type2, lengthPrefixBytes) {
  const bytesReader = isInstance(serialized, BytesReader) ? serialized : new BytesReader(serialized);
...
function serializePayloadBytes(payload) {
  ...
  switch (payload.payloadType) {
    ...
    case PayloadType.TenureChange:
      bytesArray.push(hexToBytes2(payload.tenureHash));
      bytesArray.push(hexToBytes2(payload.previousTenureHash));
      bytesArray.push(hexToBytes2(payload.burnViewHash));
      bytesArray.push(hexToBytes2(payload.previousTenureEnd));
      ...
      bytesArray.push(hexToBytes2(payload.publicKeyHash));
      break;
  }
  return concatArray(bytesArray);
}
...
function serializeMessageSignatureBytes(messageSignature) {
  return hexToBytes2(messageSignature.data);
}
function serializeTransactionAuthFieldBytes(field) {
  ...
  switch (field.contents.type) {
    case StacksWireType.PublicKey:
      ...
      bytesArray.push(hexToBytes2(compressPublicKey(field.contents.data)));
      break;
    case StacksWireType.MessageSignature:
...
function addressFromPublicKeys(version, hashMode, numSigs, publicKeys) {
  ...
  if (hashMode === AddressHashMode.P2WPKH || hashMode === AddressHashMode.P2WSH || hashMode === AddressHashMode.P2WSHNonSequential) {
    if (!publicKeys.map((p2) => p2.data).every(publicKeyIsCompressed)) {
...
function addressFromVersionHash(version, hash5) {
  return { type: StacksWireType.Address, version, hash160: hash5 };
}
...
function deserializeCV(serializedClarityValue) {
  ...
  if (typeof serializedClarityValue === "string") {
    ...
    bytesReader = new BytesReader(hexToBytes2(hasHexPrefix ? serializedClarityValue.slice(2) : serializedClarityValue));
  ...
  const type2 = bytesReader.readUInt8Enum(ClarityWireType, (n) => {
...
function serializeBufferCV(cv) {
  ...
  return bytesWithTypeID(cv.type, concatBytes(length, hexToBytes2(cv.value)));
}
...
function serializeTupleCV(cv) {
  ...
  bytesArray.push(length);
  const lexicographicOrder = Object.keys(cv.value).sort((a, b2) => a.localeCompare(b2));
...
function sequence(combinators, reduce = (v2) => v2[0]) {
  return (s) => {
    let rest = s;
    let value = "";
    const captures = [];
...
function chain(combinators, reduce = (v2) => v2[0]) {
...
function greedy(min, combinator, reduce = (v2) => v2[v2.length - 1], separator) {
  return (s) => {
    let rest = s;
    let value = "";
    const captures = [];
...
function clInt() {
  return capture(regex(/\-?[0-9]+/), (v2) => cl_exports.int(parseInt(v2)));
}
function clUint() {
  return sequence([regex(/u/), capture(regex(/[0-9]+/), (v2) => cl_exports.uint(parseInt(v2)))]);
}
function clBool() {
  return capture(regex(/true|false/), (v2) => cl_exports.bool(v2 === "true"));
}
...
function clTuple() {
  const tupleCurly = chain([
    ...
    greedy(1, sequence([
      ...
      whitespace(),
      clValue()
    ], ([k2, v2]) => cl_exports.tuple({ [k2]: v2 })), (c) => cl_exports.tuple(Object.assign({}, ...c.map((t) => t.value))), regex(/\s*\,\s*/)),
    regex(/\}/)
  ]);
  const tupleFunction = parens(sequence([
    ...
    greedy(1, parens(sequence([
      ...
      clValue(),
      optional(whitespace())
    ], ([k2, v2]) => cl_exports.tuple({ [k2]: v2 }))), (c) => cl_exports.tuple(Object.assign({}, ...c.map((t) => t.value))), whitespace())
  ]));
...
var hash160 = (input) => {
  return ripemd160(sha2564(input));
};
...
utils.hmacSha256Sync = (key, ...msgs) => {
  const h = hmac.create(sha2564, key);
  msgs.forEach((msg) => h.update(msg));
  return h.digest();
};
function createStacksPublicKey(publicKey) {
  publicKey = typeof publicKey === "string" ? hexToBytes2(publicKey) : publicKey;
  return {
...
function publicKeyFromSignatureVrs(messageHash, messageSignature, pubKeyEncoding = PubKeyEncoding.Compressed) {
  ...
  const signature = new Signature(hexToBigInt2(parsedSignature.r), hexToBigInt2(parsedSignature.s));
...
function privateKeyToPublic(privateKey) {
  ...
  const isCompressed2 = privateKeyIsCompressed(privateKey);
  return bytesToHex(getPublicKey(privateKey.slice(0, 32), isCompressed2));
}
...
function sigHashPreSign(curSigHash, authType, fee, nonce) {
  ...
  if (hexToBytes2(sigHash).byteLength !== hashLength) {
    throw Error("Invalid signature hash length");
  }
  return txidFromData(hexToBytes2(sigHash));
}
function sigHashPostSign(curSigHash, pubKey, signature) {
  ...
  const sigHashBytes = hexToBytes2(sigHash);
...
function verify3(condition, initialSigHash, authType) {
  if (isSingleSig(condition)) {
...
function verifyOrigin(auth, initialSigHash) {
  switch (auth.authType) {
    case AuthType.Standard:
      return verify3(auth.spendingCondition, initialSigHash, AuthType.Standard);
    case AuthType.Sponsored:
      return verify3(auth.spendingCondition, initialSigHash, AuthType.Standard);
    default:
...
(function(ClarityAbiTypeId3) {
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeUInt128"] = 1] = "ClarityAbiTypeUInt128";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeInt128"] = 2] = "ClarityAbiTypeInt128";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeBool"] = 3] = "ClarityAbiTypeBool";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypePrincipal"] = 4] = "ClarityAbiTypePrincipal";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeNone"] = 5] = "ClarityAbiTypeNone";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeBuffer"] = 6] = "ClarityAbiTypeBuffer";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeResponse"] = 7] = "ClarityAbiTypeResponse";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeOptional"] = 8] = "ClarityAbiTypeOptional";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeTuple"] = 9] = "ClarityAbiTypeTuple";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeList"] = 10] = "ClarityAbiTypeList";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeStringAscii"] = 11] = "ClarityAbiTypeStringAscii";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeStringUtf8"] = 12] = "ClarityAbiTypeStringUtf8";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeTraitReference"] = 13] = "ClarityAbiTypeTraitReference";
...
var fromPublicKey2 = publicKeyToAddressSingleSig;
...
function formatList(cv, space, depth = 1) {
  ...
  const items = cv.value.map((v2) => prettyPrintWithDepth(v2, space, depth)).join(spaceBefore);
...
function stringify3(cv, space = 0) {
  return prettyPrintWithDepth(cv, space, 0);
}
var prettyPrint = stringify3;
...
var buffer = bufferCV;
var bufferFromHex = (hex) => bufferCV(hexToBytes2(hex));
...
function intToBigInt2(value, signed) {
  ...
  if (parsedValue instanceof Uint8Array) {
    if (signed) {
      const bn = fromTwos2(BigInt(`0x${bytesToHex3(parsedValue)}`), BigInt(parsedValue.byteLength * 8));
...
function bigIntToBytes2(value, length = 16) {
  const hex = intToHex2(value, length);
...
function hexToBytes5(hex) {
  ...
  for (let i = 0; i < array.length; i++) {
    const j2 = i * 2;
    const hexByte = paddedHex.slice(j2, j2 + 2);
    const byte = Number.parseInt(hexByte, 16);
    if (Number.isNaN(byte) || byte < 0)
      throw new Error("Invalid byte sequence");
    array[i] = byte;
...
function concatArray2(elements) {
  return concatBytes3(...elements.map((e2) => {
    if (typeof e2 === "number")
      return octetsToBytes2([e2]);
    if (e2 instanceof Array)
      return octetsToBytes2(e2);
    return e2;
  }));
...
var DEFAULT_CHAIN_ID2 = ChainID3.Mainnet;
...
var DEFAULT_TRANSACTION_VERSION2 = TransactionVersion4.Mainnet;
...
var import_c32check10 = __toESM(require_lib());
...
var MAX_U1282 = BigInt("0xffffffffffffffffffffffffffffffff");
var MIN_U1282 = BigInt(0);
var MAX_I1282 = BigInt("0x7fffffffffffffffffffffffffffffff");
var MIN_I1282 = BigInt("-170141183460469231731687303715884105728");

// node_modules/@stacks/transactions-v6/dist/esm/keys.js
var import_c32check9 = __toESM(require_lib());
utils.hmacSha256Sync = (key, ...msgs) => {
  const h = hmac.create(sha2564, key);
  msgs.forEach((msg) => h.update(msg));
  return h.digest();
...
var TenureChangeCause2;
(function(TenureChangeCause3) {
  TenureChangeCause3[TenureChangeCause3["BlockFound"] = 0] = "BlockFound";
  TenureChangeCause3[TenureChangeCause3["Extended"] = 1] = "Extended";
})(TenureChangeCause2 || (TenureChangeCause2 = {}));
...
(function(AuthFieldType3) {
  ...
  AuthFieldType3[AuthFieldType3["SignatureCompressed"] = 2] = "SignatureCompressed";
  AuthFieldType3[AuthFieldType3["SignatureUncompressed"] = 3] = "SignatureUncompressed";
})(AuthFieldType2 || (AuthFieldType2 = {}));

// node_modules/@stacks/transactions-v6/dist/esm/types.js
function serializeAddress(address2) {
  const bytesArray = [];
  bytesArray.push(hexToBytes5(intToHex2(address2.version, 1)));
  bytesArray.push(hexToBytes5(address2.hash160));
...
function serializeLPString(lps) {
  ...
  const length = contentBytes.byteLength;
  bytesArray.push(hexToBytes5(intToHex2(length, lps.lengthPrefixBytes)));
  bytesArray.push(contentBytes);
  return concatArray2(bytesArray);
}
...
function serializeBufferCV2(cv) {
  ...
  return bytesWithTypeID2(cv.type, concatBytes3(length, cv.buffer));
}
...
// node_modules/@stacks/transactions-v6/dist/esm/utils.js
var exceedsMaxLengthBytes2 = (string, maxLengthBytes) => string ? utf8ToBytes3(string).length > maxLengthBytes : false;
...
var import_c32check11 = __toESM(require_lib());

// node_modules/@stacks/transactions-v6/dist/esm/contract-abi.js
var ClarityAbiTypeId2;
(function(ClarityAbiTypeId3) {
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeUInt128"] = 1] = "ClarityAbiTypeUInt128";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeInt128"] = 2] = "ClarityAbiTypeInt128";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeBool"] = 3] = "ClarityAbiTypeBool";
  ...
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeStringUtf8"] = 12] = "ClarityAbiTypeStringUtf8";
  ClarityAbiTypeId3[ClarityAbiTypeId3["ClarityAbiTypeTraitReference"] = 13] = "ClarityAbiTypeTraitReference";
})(ClarityAbiTypeId2 || (ClarityAbiTypeId2 = {}));

// node_modules/@stacks/transactions-v6/dist/esm/structuredDataSignature.js
var STRUCTURED_DATA_PREFIX2 = new Uint8Array([83, 73, 80, 48, 49, 56]);
...
var EthersHelpersUtil = {
  hexStringToNumber(value) {
    ...
    const number2 = parseInt(string, 16);
    return number2;
  },
...
function verify4(options) {
  ...
  return secp256r12.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex2(publicKey).substring(2), ...hash5 ? [{ prehash: true, lowS: true }] : []);
}
...
function toBytes3(value) {
  ...
  for (let i = 0, j2 = 0; i < base642.length; i += 4, j2 += 3) {
    const x2 = (characterToInteger[decoded[i]] << 18) + (characterToInteger[decoded[i + 1]] << 12) + (characterToInteger[decoded[i + 2]] << 6) + characterToInteger[decoded[i + 3]];
    decoded[j2] = x2 >> 16;
...
function verify5(options) {
  const { challenge, hash: hash5 = true, metadata, publicKey, signature } = options;
  ...
  if (!challengeMatch)
    return false;
  const [_2, challenge_extracted] = challengeMatch;
...
function deserialize2(value) {
  ...
  if (typeId === serializedWebAuthnType) {
    ...
    for (let split2 = 37; split2 < webauthnDataSize; split2++) {
      const potentialJson = toString(slice(webauthnData, split2));
      if (potentialJson.startsWith("{") && potentialJson.endsWith("}")) {
        try {
          JSON.parse(potentialJson);
          authenticatorData = slice(webauthnData, 0, split2);
  ...
  if (typeId === serializedKeychainType) {
    ...
    const inner = deserialize2(slice(data, 20));
    return {
      userAddress,
      inner,
      type: "keychain"
...
function serialize2(envelope, options = {}) {
  ...
  if (type2 === "keychain") {
    const keychain = envelope;
    return concat2(serializedKeychainType, keychain.userAddress, serialize2(keychain.inner), options.magic ? magicBytes : "0x");
  }
  throw new CoercionError({ envelope });
}
...
function verify6(signature, parameters) {
  ...
  throw new VerificationError3(`Unable to verify signature envelope of type "${envelope.type}".`);
}
...
var VerificationError3 = class extends BaseError2 {
  constructor() {
    super(...arguments);
    Object.defineProperty(this, "name", {
      enumerable: true,
...
function fromRpcList2(authorizationList) {
  return authorizationList.map((x2) => fromRpc3(x2));
}
function fromTuple2(tuple2) {
  const [chainId, address2, nonce, signatureSerialized] = tuple2;
  const args = {
    address: address2,
...
function fromTupleList(tupleList) {
  const list2 = [];
  for (const tuple2 of tupleList)
    list2.push(fromTuple2(tuple2));
  return list2;
}
...
function toRpc3(authorization) {
  const { address: address2, chainId, nonce, signature } = authorization;
  return {
    address: address2,
...
function toRpcList2(authorizationList) {
  return authorizationList.map((x2) => toRpc3(x2));
}
...
function toTupleList(list2) {
  if (!list2 || list2.length === 0)
    return [];
  const tupleList = [];
  for (const authorization of list2)
...
function toRpc4(authorization) {
  const { address: address2, chainId = 0n, expiry, limits, type: type2, signature } = authorization;
  return {
...
function toTuple3(authorization) {
  const { address: address2, chainId = 0n, expiry, limits } = authorization;
  const signature = authorization.signature ? serialize2(authorization.signature) : void 0;
  const type2 = (() => {
...
function fromAddress(address2) {
  if (!address2.toLowerCase().startsWith(tip20Prefix))
    throw new Error("invalid tip20 address.");
  return toBigInt(slice(address2, tip20Prefix.length));
}
...
function fromPrice(price) {
  ...
  const [w2, d = "0"] = priceStr.split(".");
  const whole = BigInt(w2);
...
function toRpc11(request) {
  ...
  if (request.calls || typeof request.feeToken !== "undefined" || typeof request.validBefore !== "undefined" || typeof request.validAfter !== "undefined" || request.type === "tempo") {
...
function toTupleList2(accessList) {
  ...
  for (const { address: address2, storageKeys } of accessList) {
    for (let j2 = 0; j2 < storageKeys.length; j2++)
      if (size(storageKeys[j2]) !== 32)
        throw new InvalidStorageKeySizeError({
          storageKey: storageKeys[j2]
        });
    if (address2)
      assert(address2, { strict: false });
    tuple2.push([address2, storageKeys]);
  }
  return tuple2;
}
...
function serialize4(envelope, options = {}) {
  ...
  const serialized = [
    ...
    ...signature ? [serialize2(from4(signature))] : []
  ];
...
function formatTransaction2(transaction) {
  ...
  const { feePayerSignature, gasPrice: _2, nonce, ...tx } = Transaction_exports.fromRpc(transaction);
  return {
    ...tx,
...
function formatTransactionRequest2(r, action) {
  ...
  if ((account == null ? void 0 : account.type) === "json-rpc") {
    if (((_a = rpc.calls) == null ? void 0 : _a.length) && rpc.calls.length > 1)
      throw new Error("Batch calls are not supported with JSON-RPC accounts yet.");
    rpc.data = (_c = (_b = rpc.calls) == null ? void 0 : _b.at(0)) == null ? void 0 : _c.data;
    rpc.to = (_e2 = (_d = rpc.calls) == null ? void 0 : _d.at(0)) == null ? void 0 : _e2.to;
    rpc.type = void 0;
  }
  if ((account == null ? void 0 : account.type) !== "json-rpc") {
    rpc.to = void 0;
...
var chainConfig5 = {
  ...
  async prepareTransactionRequest(r) {
    ...
    request.nonceKey = (() => {
      ...
      const address2 = ((_a2 = request.account) == null ? void 0 : _a2.address) ?? request.from;
      if (!address2)
        return void 0;
      if (!request.chain)
        return void 0;
  ...
  async verifyHash(client, parameters) {
    const { address: address2, hash: hash5, signature } = parameters;
    if (typeof signature === "string" && signature.endsWith(magicBytes.slice(2))) {
      const envelope = deserialize2(signature);
...
var WcHelpersUtil = {
  ...
  getWalletConnectAccounts(universalProvider, namespace) {
    ...
    const accounts = (_d = (_c = (_b = (_a = universalProvider == null ? void 0 : universalProvider.session) == null ? void 0 : _a.namespaces) == null ? void 0 : _b[namespace]) == null ? void 0 : _c.accounts) == null ? void 0 : _d.map((account) => ParseUtil.parseCaipAddress(account)).filter(({ address: address2 }) => {
...
var ConnectionManager = class {
  ...
  async syncBitcoinConnections({ connectors, caipNetwork, universalProvider, getConnectionStatusInfo, onConnection, onListenProvider }) {
    await Promise.all(connectors.filter((c) => {
      ...
      const chain2 = connector.chains.find((c) => c.id === (caipNetwork == null ? void 0 : caipNetwork.id)) || connector.chains[0];
      if (!chain2) {
  ...
  getConnection({ address: address2, connectorId, connections, connectors }) {
    if (connectorId) {
      ...
      const account = address2 ? connection.accounts.find((a) => HelpersUtil.isLowerCaseMatch(a.address, address2)) : connection.accounts[0];
...
var UniversalAdapter = class extends AdapterBlueprint {
  ...
  async getAccounts({ namespace }) {
    ...
    const addresses = ((_d = (_c = (_b = (_a = provider == null ? void 0 : provider.session) == null ? void 0 : _a.namespaces) == null ? void 0 : _b[namespace]) == null ? void 0 : _c.accounts) == null ? void 0 : _d.map((account) => {
      ...
      return address2;
    }).filter((address2, index, self2) => self2.indexOf(address2) === index)) || [];
    return Promise.resolve({
...
var featureConfig = {
  email: {
    ...
    processApi: (apiConfig) => {
      ...
      const config4 = apiConfig.config;
      return Boolean(apiConfig.isEnabled) && config4.includes("email");
    },
  ...
  socials: {
    ...
    processApi: (apiConfig) => {
      ...
      const config4 = apiConfig.config;
      return Boolean(apiConfig.isEnabled) && config4.length > 0 ? config4.filter((s) => s !== "email") : false;
    },
    processFallback: (localValue) => {
      if (localValue === void 0) {
  ...
  swaps: {
    ...
    processApi: (apiConfig) => {
      ...
      const config4 = apiConfig.config;
      return Boolean(apiConfig.isEnabled) && config4.length > 0 ? config4 : false;
    },
    processFallback: (localValue) => {
      if (localValue === void 0) {
...
var ConfigUtil = {
  ...
  addWarning(localFeatureValue, featureKey) {
    if (localFeatureValue !== void 0) {
      const config4 = featureConfig[featureKey];
      const warningName = config4.isLegacy ? `"features.${config4.localFeatureName}" (now "${featureKey}")` : `"features.${featureKey}"`;
      this.localSettingsOverridden.add(warningName);
    }
  },
  processFeature(featureKey, localFeatures, apiProjectConfig, useApi, isBasic) {
    const config4 = featureConfig[featureKey];
    const localValue = localFeatures[config4.localFeatureName];
    if (isBasic && !config4.isAvailableOnBasic) {
      return false;
    }
    if (useApi) {
      const apiConfig = this.getApiConfig(config4.apiFeatureName, apiProjectConfig);
  ...
  async fetchRemoteFeatures(config4) {
    const isBasic = config4.basic ?? false;
    const localFeatures = config4.features || {};
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.setRequestedCaipNetworks = (requestedCaipNetworks, chain2) => {
      ChainController.setRequestedCaipNetworks(requestedCaipNetworks, chain2);
    };
    ...
    this.setCaipAddress = (caipAddress, chain2) => {
      AccountController.setCaipAddress(caipAddress, chain2);
    };
    this.setBalance = (balance, balanceSymbol, chain2) => {
      AccountController.setBalance(balance, balanceSymbol, chain2);
    };
    this.setProfileName = (profileName, chain2) => {
      AccountController.setProfileName(profileName, chain2);
    };
    this.setProfileImage = (profileImage, chain2) => {
      AccountController.setProfileImage(profileImage, chain2);
    };
    this.setUser = (user, chain2) => {
      AccountController.setUser(user, chain2);
    };
    this.resetAccount = (chain2) => {
      AccountController.resetAccount(chain2);
    };
    ...
    this.setStatus = (status, chain2) => {
      AccountController.setStatus(status, chain2);
    ...
    this.setConnectedWalletInfo = (connectedWalletInfo, chain2) => {
      const type2 = ProviderUtil.getProviderId(chain2);
      const walletInfo = connectedWalletInfo ? { ...connectedWalletInfo, type: type2 } : void 0;
      AccountController.setConnectedWalletInfo(walletInfo, chain2);
    };
    this.getIsConnectedState = () => Boolean(ChainController.state.activeCaipAddress);
    this.addAddressLabel = (address2, label, chain2) => {
      AccountController.addAddressLabel(address2, label, chain2);
    };
    this.removeAddressLabel = (address2, chain2) => {
      AccountController.removeAddressLabel(address2, chain2);
    };
    ...
    this.setAddressExplorerUrl = (addressExplorerUrl, chain2) => {
      AccountController.setAddressExplorerUrl(addressExplorerUrl, chain2);
    };
    this.setSmartAccountDeployed = (isDeployed, chain2) => {
      AccountController.setSmartAccountDeployed(isDeployed, chain2);
    };
    this.setPreferredAccountType = (preferredAccountType, chain2) => {
  ...
  createClients() {
    this.connectionControllerClient = {
      ...
      connectExternal: async ({ id, address: address2, info, type: type2, provider, chain: chain2, caipNetwork, socialUri }) => {
        var _a, _b, _c, _d, _e2, _f;
        const activeChain = ChainController.state.activeChain;
        const namespace = chain2 || activeChain;
        const adapter = this.getAdapter(namespace);
        if (chain2 && chain2 !== activeChain && !caipNetwork) {
          const toConnectNetwork = this.getCaipNetworks().find((network) => network.chainNamespace === chain2);
          if (toConnectNetwork) {
        ...
        const res = await adapter.connect({
          ...
          rpcUrl: ((_c = (_b = (_a = caipNetwork == null ? void 0 : caipNetwork.rpcUrls) == null ? void 0 : _a.default) == null ? void 0 : _b.http) == null ? void 0 : _c[0]) || ((_f = (_e2 = (_d = fallbackCaipNetwork == null ? void 0 : fallbackCaipNetwork.rpcUrls) == null ? void 0 : _d.default) == null ? void 0 : _e2.http) == null ? void 0 : _f[0])
        });
        if (!res) {
          return void 0;
        }
      ...
      reconnectExternal: async ({ id, info, type: type2, provider }) => {
        ...
        if (adapter == null ? void 0 : adapter.reconnect) {
          await (adapter == null ? void 0 : adapter.reconnect({ id, info, type: type2, provider, chainId: (_a = this.getCaipNetwork()) == null ? void 0 : _a.id }));
          StorageUtil.addConnectedNamespace(namespace);
          this.syncConnectedWalletInfo(namespace);
        }
      },
  ...
  syncProvider({ type: type2, provider, id, chainNamespace }) {
  ...
  getAccount(_namespace) {
    ...
    const allAccounts = connections.flatMap((connection) => connection.accounts.map(({ address: address2, type: type2 }) => CoreHelperUtil.createAccount(namespace, address2, type2 || "eoa")));
    if (!accountState) {
      return void 0;
    }
    return {
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-KXDPHXCJ.js");
      await import("./w3m-modal-JF3J7BYO.js");
...
var UniversalConnector = class _UniversalConnector {
  constructor({ appKit, provider, config: config4 }) {
    this.appKit = appKit;
    this.provider = provider;
    this.config = config4;
  }
  static async init(config4) {
    const provider = await vi.init({
      projectId: config4.projectId,
      metadata: config4.metadata
    });
    const appKitConfig = {
      networks: config4.networks.flatMap((network) => network.chains),
      projectId: config4.projectId,
      metadata: config4.metadata,
    ...
    return new _UniversalConnector({ appKit, provider, config: config4 });
  }
  async connect() {
    var _a;
    const namespaces = (_a = this.config) == null ? void 0 : _a.networks.reduce((acc, namespace) => {
      ...
      acc[namespace.namespace] = {
        ...
        chains: ((_a2 = namespace == null ? void 0 : namespace.chains) == null ? void 0 : _a2.map((chain2) => chain2.caipNetworkId)) || []
      };
      return acc;
    }, {});
    try {
  ...
  async request(params, chain2) {
    return await this.provider.request(params, chain2);
  }
};
...
var Ie = (e2, t, s) => t in e2 ? ye(e2, t, { enumerable: true, configurable: true, writable: true, value: s }) : e2[t] = s;
var p = (e2, t) => {
  for (var s in t || (t = {})) xe.call(t, s) && Ie(e2, s, t[s]);
  if (E) for (var s of E(t)) Ne.call(t, s) && Ie(e2, s, t[s]);
  return e2;
};
var M = (e2, t) => $e(e2, et(t));
var Ce = (e2, t) => {
  var s = {};
  for (var o in e2) xe.call(e2, o) && t.indexOf(o) < 0 && (s[o] = e2[o]);
  if (e2 != null && E) for (var o of E(e2)) t.indexOf(o) < 0 && Ne.call(e2, o) && (s[o] = e2[o]);
  return s;
};
var tt = (e2, t) => {
  for (var s in t) ye(e2, s, { get: t[s], enumerable: true });
};
...
function k(e2, t) {
  var s, o;
  return e2 instanceof t || ((o = (s = e2 == null ? void 0 : e2.constructor) == null ? void 0 : s.name) == null ? void 0 : o.toLowerCase()) === t.name;
}
function b(e2) {
  return e2 ? typeof e2 == "string" ? e2 : k(e2, StacksMainnet) ? "mainnet" : k(e2, StacksTestnet) ? "testnet" : k(e2, StacksDevnet) || k(e2, StacksMocknet) ? "devnet" : "coreApiUrl" in e2 ? e2.coreApiUrl : "url" in e2 ? e2.url : "transactionVersion" in e2 ? e2.transactionVersion === TransactionVersion.Mainnet ? "mainnet" : "testnet" : "mainnet" : "mainnet";
}
function N(e2) {
  ...
  switch (e2.type) {
    ...
    case ClarityType2.List:
      return cl_exports.list(e2.list.map(N));
    case ClarityType2.Tuple:
      return cl_exports.tuple(Object.fromEntries(Object.entries(e2.data).map(([s, o]) => [s, N(o)])));
    case ClarityType2.OptionalNone:
      return cl_exports.none();
    case ClarityType2.OptionalSome:
      return cl_exports.some(N(e2.value));
    case ClarityType2.ResponseErr:
      return cl_exports.error(N(e2.value));
    case ClarityType2.ResponseOk:
      return cl_exports.ok(N(e2.value));
    case ClarityType2.PrincipalContract:
...
function Oe(e2) {
  return M(p({}, e2), { onFinish: void 0, onCancel: void 0 });
}
function ut(e2) {
}
var pt = async (e2) => {
};
var Mt = "stx_updateProfile";
var F = (e2) => e2;
var q = (e2) => e2.profile;
function lt(e2, t = S()) {
  f2(Mt, F, q)(e2, t);
...
var yt = "stx_signStructuredMessage";
var H = (e2) => ({ message: N(e2.message), domain: N(e2.domain) });
var V = (e2) => e2;
function xt(e2, t = S()) {
  if (e2.domain.type !== ClarityType2.Tuple) throw new Error("Domain must be a tuple");
  f2(yt, H, V)(e2, t);
}
var Re = (e2) => {
  let t = e2;
  if (!t) {
    let s = new v(["store_write"], document.location.href);
    t = new T({ appConfig: s });
  }
  return t;
};
function Dt(e2) {
  try {
    return Re(e2).loadUserData().appPrivateKey;
  } catch (t) {
    return false;
  }
}
...
function Lt(e2) {
  var u;
  let { stxAddress: t, userSession: s, network: o } = e2;
  if (t) return t;
  if (!s || !o) return;
  let n = (u = s == null ? void 0 : s.loadUserData().profile) == null ? void 0 : u.stxAddress, r = { [ChainId.Mainnet]: "mainnet", [ChainId.Testnet]: "testnet" }, i = je(o);
  return n == null ? void 0 : n[r[i.chainId]];
}
var Pt = async (e2) => {
};
var wt = async (e2) => {
...
var Ot = "stx_callContract";
var K = (e2) => {
  var s;
  let t = (s = e2.functionArgs) == null ? void 0 : s.map((o) => typeof o == "string" ? cl_exports.deserialize(o) : N(o)).map((o) => cl_exports.serialize(o));
  return M(p({}, e2), { contract: `${e2.contractAddress}.${e2.contractName}`, functionArgs: t, network: b(e2.network), postConditionMode: _e(e2.postConditionMode), postConditions: ve(e2.postConditions), address: e2.stxAddress });
};
var J = (e2) => ({ txId: e2.txid, txRaw: e2.transaction, stacksTransaction: deserializeTransaction(e2.transaction) });
function Et(e2, t = S()) {
  f2(Ot, K, J)(e2, t);
}
var kt = "stx_deployContract";
var $ = (e2) => M(p({}, e2), { name: e2.contractName, clarityCode: e2.codeBody, network: b(e2.network), postConditionMode: _e(e2.postConditionMode), postConditions: ve(e2.postConditions), address: e2.stxAddress });
var ee = (e2) => ({ txId: e2.txid, txRaw: e2.transaction, stacksTransaction: deserializeTransaction(e2.transaction) });
function bt(e2, t = S()) {
  f2(kt, $, ee)(e2, t);
}
var Rt = "stx_transferStx";
var te = (e2) => M(p({}, e2), { amount: e2.amount.toString(), network: b(e2.network), address: e2.stxAddress });
var se = (e2) => ({ txId: e2.txid, txRaw: e2.transaction, stacksTransaction: deserializeTransaction(e2.transaction) });
function vt(e2, t = S()) {
  f2(Rt, te, se)(e2, t);
}
var _t = "stx_signTransaction";
var oe = (e2) => M(p({}, e2), { transaction: e2.txHex });
var ne = (e2) => M(p({}, e2), { stacksTransaction: deserializeTransaction(e2.transaction) });
function Ut(e2, t = S()) {
  f2(_t, oe, ne)(e2, t);
}
function ve(e2) {
  if (typeof e2 != "undefined") return e2.map((t) => typeof t == "string" ? t : typeof t.type == "string" ? M(p({}, t), { amount: "amount" in t ? t.amount.toString() : void 0 }) : bytesToHex(serializePostCondition(t)));
}
function _e(e2) {
...
function L(e2, t, s) {
  return (o, n) => {
    let r = t(Oe(o)), i = o;
    w({ provider: n }, e2, r).then((d) => {
      var c;
      let u = s(d);
      (c = i.onFinish) == null || c.call(i, u);
    }).catch((d) => {
      var u;
      console.error(d), (u = i.onCancel) == null || u.call(i, d);
    });
  };
}
var zt = ze;
var Ao = L("stx_transferStx", te, se);
var fo = L("stx_callContract", K, J);
var mo = L("stx_deployContract", $, ee);
var Io = L("stx_signTransaction", oe, ne);
var yo = L("stx_updateProfile", F, q);
var xo = L("stx_signMessage", Z, X);
var No = L("stx_signStructuredMessage", H, V);
var Co = zt;
var re = "@stacks/connect";
var Ft = { addresses: { stx: [], btc: [] }, version: "0.0.1" };
var Ye = (e2) => [...new Map(e2.map((s) => [s.address, s])).values()].map((o) => {
  var s = Ce(o, []);
  return "publicKey" in s && delete s.publicKey, "derivationPath" in s && delete s.derivationPath, "tweakedPublicKey" in s && delete s.tweakedPublicKey, s;
});
function Ge(e2) {
  try {
    let s = ae() || Ft, o = M(p({}, s), { updatedAt: Date.now(), addresses: p(p({}, s.addresses), e2.addresses && { stx: e2.addresses.stx && Ye([...s.addresses.stx, ...e2.addresses.stx]), btc: e2.addresses.btc && Ye([...s.addresses.btc, ...e2.addresses.btc]) }) });
    localStorage.setItem(re, bytesToHex(utf8ToBytes(JSON.stringify(o))));
  } catch (t) {
...
function ae() {
  try {
    let e2 = localStorage.getItem(re);
    return e2 ? JSON.parse(bytesToUtf8(hexToBytes2(e2))) : null;
  } catch (e2) {
...
function qt() {
  let e2 = getProvider();
  e2 && "disconnect" in e2 && e2.disconnect(), clearSelectedProviderId(), Be(), new T().store.deleteSessionData();
}
function Zt() {
  let e2 = ae();
...
var ce = {};
tt(ce, { Chains: () => y, Default: () => ie, Networks: () => j });
var Vt = ["stx_signMessage", "stx_signTransaction", "stx_signStructuredMessage", "stx_getAccounts", "stx_getAddresses", "stx_updateProfile", "stx_transferStx", "stx_transferSip10Ft", "stx_transferSip9Nft", "stx_callContract", "stx_deployContract", "sendTransfer", "signPsbt", "getAddresses"];
var y;
((s) => {
  ((r) => (r.Mainnet = { id: 1, chainNamespace: "stacks", caipNetworkId: "stacks:1", name: "Stacks", nativeCurrency: { name: "STX", symbol: "STX", decimals: 6 }, rpcUrls: { default: { http: ["https://api.mainnet.hiro.so"] } } }, r.Testnet = { id: 2, chainNamespace: "stacks", caipNetworkId: "stacks:2147483648", name: "Stacks Testnet", nativeCurrency: { name: "STX", symbol: "STX", decimals: 6 }, rpcUrls: { default: { http: ["https://api.testnet.hiro.so"] } } }))(s.Stacks || (s.Stacks = {}));
  ((r) => (r.Mainnet = bitcoin, r.Testnet = bitcoinTestnet))(s.Bitcoin || (s.Bitcoin = {}));
})(y || (y = {}));
var j;
((s) => (s.Stacks = { namespace: "stacks", chains: [y.Stacks.Mainnet, y.Stacks.Testnet], methods: Vt, events: ["stx_chainChanged", "stx_accountsChanged"] }, s.Bitcoin = { namespace: "bip122", chains: [y.Bitcoin.Mainnet], methods: ["signMessage", "sendTransfer", "signPsbt", "getAccountAddresses"], events: ["bip122_addressesChanged"] }))(j || (j = {}));
var ie = { metadata: { name: "Universal Connector", description: "Universal Connector", url: "https://appkit.reown.com", icons: ["https://appkit.reown.com/icon.png"] }, networks: [j.Stacks, j.Bitcoin] };
function We(e2) {
  return { jsonrpc: "2.0", id: 1, result: e2 };
}
var de = class {
  constructor(t) {
    this.connector = t;
  ...
  async connect() {
    try {
      let { session: t } = await this.connector.connect();
      return t;
    } catch (t) {
      throw console.error(">> WalletConnectProvider connect error", t), t;
    }
  }
  get stacksAddresses() {
    var i, d, u, c;
    let t = (i = this.connector.provider) == null ? void 0 : i.session;
    if (!((u = (d = t == null ? void 0 : t.namespaces) == null ? void 0 : d.stacks) != null && u.accounts)) return [];
    let s = (c = t == null ? void 0 : t.sessionProperties) == null ? void 0 : c.stacks_getAddresses, o = JSON.parse(s || "[]"), r = [...t.namespaces.stacks.accounts.map((a) => ({ address: a.split(":")[2], publicKey: "" })) || [], ...o || []].sort((a) => a.publicKey ? 1 : -1);
    return Array.from(new Map(r.map((a) => [a.address, a])).values());
  }
  get btcAddresses() {
    var i, d, u;
    let t = (i = this.connector.provider) == null ? void 0 : i.session;
    if (!((u = (d = t == null ? void 0 : t.namespaces) == null ? void 0 : d.bip122) != null && u.accounts)) return [];
    let s = t == null ? void 0 : t.sessionProperties.bip122_getAccountAddresses, o = JSON.parse(s || "{}"), n = t.namespaces.bip122.accounts.map((c) => ({ address: c.split(":")[2], publicKey: "" })), r = [...(o == null ? void 0 : o.payment.map((c) => M(p({}, c), { purpose: "payment" }))) || [], ...(o == null ? void 0 : o.ordinal.map((c) => M(p({}, c), { purpose: "ordinal" }))) || [], ...n || []].sort((c) => c.publicKey ? 1 : -1).sort((c, a) => (c == null ? void 0 : c.address.length) - (a == null ? void 0 : a.address.length));
    return Array.from(new Map(r.map((c) => [c.address, c])).values());
  }
  async getAddresses() {
    var r;
    let t = (r = this.connector.provider) == null ? void 0 : r.session;
    t || (t = await this.connect());
    let s = this.stacksAddresses, o = this.btcAddresses;
    return { addresses: [...s, ...o] };
  }
  validateRpcMethod(t) {
    var d, u, c, a;
    if (["getAddresses", "stx_getAccounts", "stx_getAddresses"].includes(t)) return;
    if (!((d = this.connector.provider) != null && d.session)) throw new Error("WalletConnectProvider not connected. Please connect first.");
    let o = (u = this.connector.provider) == null ? void 0 : u.session.namespaces, n = ((c = o.stacks) == null ? void 0 : c.methods) || [], r = ((a = o.bip122) == null ? void 0 : a.methods) || [];
    if (![...n, ...r].includes(t)) throw new Error(`WalletConnectProvider does not support method ${t}. Please use a supported method.`);
  }
  getTargetCaipNetworkId(t, s) {
    var r, i, d, u, c, a, A, C;
    let o = ["getAddresses", "stx_getAccounts", "stx_getAddresses"], n = "network" in s ? s.network : void 0;
    if (n) return { mainnet: y.Stacks.Mainnet.caipNetworkId, testnet: y.Stacks.Testnet.caipNetworkId }[n];
    if (o.includes(t)) return y.Stacks.Mainnet.caipNetworkId;
    if ((u = (d = (i = (r = this.connector.provider) == null ? void 0 : r.session) == null ? void 0 : i.namespaces) == null ? void 0 : d.stacks) != null && u.methods.includes(t)) return y.Stacks.Mainnet.caipNetworkId;
    if ((C = (A = (a = (c = this.connector.provider) == null ? void 0 : c.session) == null ? void 0 : a.namespaces) == null ? void 0 : A.bip122) != null && C.methods.includes(t)) return y.Bitcoin.Mainnet.caipNetworkId;
    throw new Error(`WalletConnectProvider does not support method ${t}. Please use a supported method.`);
  }
  async request(t, s) {
    var o, n, r, i;
    try {
      this.validateRpcMethod(t);
      let d = this.getTargetCaipNetworkId(t, s);
      switch (t) {
        case "getAddresses":
        case "stx_getAddresses":
        case "stx_getAccounts":
          let u = await this.getAddresses();
          return We(u);
        case "stx_signMessage":
          let a = ((i = (r = (n = (o = this.connector.provider) == null ? void 0 : o.session) == null ? void 0 : n.namespaces) == null ? void 0 : r.stacks) == null ? void 0 : i.accounts[0]).split(":")[2], A = await this.connector.request({ method: t, params: p({ address: a }, s) }, d);
          return We(A);
        default:
          return await this.connector.request({ method: t, params: s }, d);
      }
    } catch (d) {
      throw console.error(">> WalletConnectProvider request error", d), d;
    }
  }
  async disconnect() {
...
async function ue(e2) {
  ...
  let { projectId: t, config: s } = typeof e2 == "string" ? { projectId: e2, config: void 0 } : { projectId: e2.projectId, config: e2 }, o = await UniversalConnector.init(M(p(p({}, ie), s), { projectId: t })), n = new de(o);
  window.WalletConnectProvider = n;
}
async function U(e2, t, s) {
  var o;
  try {
    let n = await e2.request(t, s);
    if (!n) throw new x("Provider did not return a response", -31e3);
    if ("error" in n) throw x.fromResponse(n.error);
    return n.result;
  } catch (n) {
    if (n instanceof x) throw n;
    if ("jsonrpc" in n) throw x.fromResponse(n.error);
    let r = (o = n.code) != null ? o : -31e3;
    throw new x(n.message, r, n.data, n);
  }
}
function rs(e2) {
  return e2 ? async function(s, o, n) {
    let r = await U(s, o, n);
    if ((o === "getAddresses" || o === "wallet_connect") && "addresses" in r) {
      let { stx: i, btc: d } = ls(r.addresses).reduce((u, c) => (u[c.address.startsWith("S") ? "stx" : "btc"].push(c), u), { stx: [], btc: [] });
      Ge({ addresses: { stx: i, btc: d } });
    }
    return r;
  } : U;
}
async function w(...e2) {
  var i;
  let { options: t, method: s, params: o } = as(e2), n = Object.assign({ provider: null, defaultProviders: Pe, forceWalletSelect: false, persistWalletSelect: true, enableOverrides: true, enableLocalStorage: true }, us(t));
  n != null && n.walletConnect ? (await ue(n.walletConnect).catch(console.error), n.defaultProviders = [...n.defaultProviders, B]) : n != null && n.walletConnectProjectId && (await ue(n.walletConnectProjectId).catch(console.error), n.defaultProviders = [...n.defaultProviders, B]), n.provider = (i = n.provider) != null ? i : getProvider();
  let r = ps(n.enableOverrides, rs(n.enableLocalStorage));
  if (n.provider && !n.forceWalletSelect) {
    let { method: d, params: u } = pe(n.provider, s, o, n.enableOverrides);
    return await r(n.provider, d, Me(u));
  }
  if (typeof window != "undefined") return defineCustomElements(window), new Promise((d, u) => {
    let c = document.createElement("connect-modal");
    c.defaultProviders = qe(n.approvedProviderIds, n.defaultProviders), c.installedProviders = qe(n.approvedProviderIds, getInstalledProviders(n.defaultProviders));
    let a = document.body.style.overflow;
    document.body.style.overflow = "hidden";
    let A = () => {
      c.remove(), document.body.style.overflow = a;
    };
    c.callback = (D) => {
      A();
      let m = getProviderFromId(D), { method: h, params: Y } = pe(m, s, o, n.enableOverrides), O = Ms(n.persistWalletSelect, D);
      d(r(m, h, Me(Y)).then(O));
    }, c.cancelCallback = () => {
      A(), u(new x("User canceled the request", -31001));
    }, document.body.appendChild(c);
    let C = (D) => {
      D.key === "Escape" && (document.removeEventListener("keydown", C), c.remove(), u(new x("User canceled the request", -31001)));
    };
...
function qe(e2, t) {
  return e2 ? t.filter((s) => e2.includes(s.id)) : t;
}
function is(e2) {
  let t = e2 && "network" in e2 ? { network: e2.network } : void 0;
  return w(M(p({}, e2), { forceWalletSelect: true }), "getAddresses", t);
}
function f2(e2, t, s) {
  return (o, n) => {
    if (!n) throw new Error("[Connect] No installed Stacks wallet found");
    let r = t(o), i = o, { method: d, params: u } = pe(n, e2, r);
    U(n, d, Me(u)).then((c) => {
      var A;
      let a = s(c);
      (A = i.onFinish) == null || A.call(i, a);
    }).catch(i.onCancel);
  };
}
function _(e2) {
...
function us(e2) {
  if (e2 === void 0) return {};
  let t = {};
  for (let [s, o] of Object.entries(e2)) o !== void 0 && (t[s] = o);
  return t;
}
function ps(e2, t) {
  return e2 ? async (s, o, n) => {
    let r = await t(s, o, n), i = p({}, r);
    return r !== null && "txId" in r && r.txId && !("txid" in i) && (i.txid = r.txId), r !== null && "hex" in r && r.hex && typeof r.hex == "string" && !("psbt" in i) && (i.psbt = base64.encode(hexToBytes2(r.hex))), i;
  } : t;
}
function pe(e2, t, s, o = true) {
  if (!o) return { method: t, params: s };
  if (_(e2) && ["getAddresses", "stx_getAddresses"].includes(t)) return { method: "wallet_connect", params: s };
  if (_(e2) && t === "sendTransfer") {
    let n = M(p({}, s), { recipients: s.recipients.map((r) => M(p({}, r), { amount: Number(r.amount) })), network: void 0 });
    return { method: t, params: n };
  }
  if (_(e2) && t === "signPsbt") {
    let n = s.signInputs;
    if (!n) return { method: t, params: s };
    let r = {};
    for (let d of n) typeof d != "number" && d.address && (r[d.address] || (r[d.address] = []), r[d.address].push(d.index));
    let i = { psbt: s.psbt, signInputs: r, broadcast: s.broadcast };
    return { method: t, params: i };
  }
  if (!_(e2) && t === "stx_signMessage") {
    let n = p({}, s);
    return delete n.publicKey, { method: t, params: n };
  }
  if (Ze(e2) && t === "sendTransfer") {
    let n = M(p({}, s), { recipients: s.recipients.map((r) => M(p({}, r), { amount: r.amount.toString() })) });
    return { method: t, params: n };
  }
  if (Ze(e2) && t === "signPsbt") {
    let n = { hex: bytesToHex(base64.decode(s.psbt)), signAtIndex: s.signInputs.map((r) => typeof r == "number" ? r : r.index), allowedSighash: s.allowedSighash, broadcast: s.broadcast, network: s.network };
    return { method: t, params: n };
  }
  return { method: t, params: s };
}
var Xe = ["stx-postcondition", "ft-postcondition", "nft-postcondition"];
function Me(e2) {
  if (!e2 || typeof e2 != "object") return e2;
  let t = p({}, e2);
  for (let [s, o] of Object.entries(e2)) {
    if (typeof o == "bigint") {
      t[s] = o.toString();
      continue;
    }
    if (o) {
      if (Array.isArray(o)) {
        t[s] = o.map((n) => typeof n == "bigint" ? n.toString() : !n || typeof n != "object" || !("type" in n) ? n : Xe.includes(n.type) ? postConditionToHex(n) : cl_exports.serialize(n));
        continue;
      }
      typeof o == "object" && "type" in o && (t[s] = Xe.includes(o.type) ? postConditionToHex(o) : cl_exports.serialize(o));
    }
  }
...
function ls(e2) {
  return e2.slice().sort((t, s) => {
    let o = "purpose" in t && t.purpose === "payment", n = "purpose" in s && s.purpose === "payment";
    return o && !n ? -1 : !o && n ? 1 : 0;
  });
}
var en = "https://app.blockstack.org";
...
var ze = async (e2, t) => {
  var i, d, u, c, a, A;
  let { onFinish: s, onCancel: o, userSession: n } = e2, r = Ke(n);
  r.isUserSignedIn() && r.signUserOut();
  try {
    let D = await w({ provider: t, forceWalletSelect: true }, "getAddresses"), m = r.store.getSessionData();
    (i = m.userData) != null || (m.userData = { profile: {} }), (u = (d = m.userData).profile) != null || (d.profile = {}), (a = (c = m.userData.profile).stxAddress) != null || (c.stxAddress = { mainnet: "", testnet: "" });
    let h = D.addresses.find((I) => (I == null ? void 0 : I.symbol) === "STX" || I.address.startsWith("S")).address.toUpperCase(), Y = h[1] === "P" || h[1] === "M";
    Object.assign(m.userData.profile.stxAddress, { [Y ? "mainnet" : "testnet"]: h });
    let O = (A = D.addresses.find((I) => {
      var fe;
      return (fe = I == null ? void 0 : I.address) != null && fe.startsWith("S") ? false : I.purpose === "payment" ? true : Ve(I == null ? void 0 : I.address) ? D.addresses.every((P) => {
        var me;
        return ((me = P == null ? void 0 : P.address) == null ? void 0 : me.startsWith("S")) || Ve(P == null ? void 0 : P.address);
      }) : true;
    })) == null ? void 0 : A.address;
    O && (m.userData.profile.btcAddress = O), r.store.setSessionData(m), s == null || s({ userSession: r, authResponsePayload: m.userData });
  } catch (C) {
    console.error("[Connect] Error during auth request", C), o == null || o(C);
  }
};
var gs = "blockstack-session";
var v = class {
  constructor(t, s, o, n, r, i) {
  }
};
var T = class {
  constructor(t) {
    t != null && t.appConfig && (this.appConfig = t.appConfig), typeof window == "undefined" && typeof self == "undefined" ? this.store = new le() : this.store = new ge();
  }
...
var ge = class extends z {
  constructor(t) {
    var o;
    super(t), this.key = typeof ((o = t == null ? void 0 : t.storeOptions) == null ? void 0 : o.localStorageKey) == "string" ? t.storeOptions.localStorageKey : gs, localStorage.getItem(this.key) || this.setSessionData({});
  }
  getSessionData() {
...
var Ke = (e2) => e2 || new T();
var sn = async (e2) => (e2 = Ke(e2), e2.isUserSignedIn() ? Promise.resolve(e2.loadUserData()) : Promise.resolve(null));
function Ve(e2) {
  let t = ["bc1p", "tb1p", "bcrt1p"], s = [62, 62, 64], o = t.findIndex((n) => e2.startsWith(n));
  return o === -1 ? false : e2.length === s[o];
}
var Ss = ((o) => (o.ContractCall = "contract_call", o.ContractDeploy = "smart_contract", o.STXTransfer = "token_transfer", o))(Ss || {});
var As = ((r) => (r.BUFFER = "buffer", r.UINT = "uint", r.INT = "int", r.PRINCIPAL = "principal", r.BOOL = "bool", r))(As || {});
...
var Ns = (e2) => {
  var t;
  return { psbt: base64.encode(hexToBytes2(e2.hex)), signInputs: typeof e2.signAtIndex == "number" ? [e2.signAtIndex] : e2.signAtIndex, allowedSighash: (t = e2.allowedSighash) == null ? void 0 : t.map((s) => Ae[s]) };
};
var Cs = (e2) => ({ hex: bytesToHex(base64.decode(e2.psbt)) });
function Ds(e2, t = S()) {
  f2(xs, Ns, Cs)(e2, t);
}
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-7VT7TXEV.js.map
