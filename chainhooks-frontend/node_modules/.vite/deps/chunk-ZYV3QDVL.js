...
var ICONS = {
  add: async () => (await import("./add-64TZ7AOS.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-CDTIKY6X.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-4HIC3MB3.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-L26LZTT7.js")).appStoreSvg,
  apple: async () => (await import("./apple-QRE5G7DE.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-TTLBQ3UX.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-3AECZFUZ.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-HKJOX43R.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-WZ2XBLGR.js")).arrowTopSvg,
  bank: async () => (await import("./bank-ZEUDJCHR.js")).bankSvg,
  browser: async () => (await import("./browser-7MTIIAXB.js")).browserSvg,
  bin: async () => (await import("./bin-ERPXE72J.js")).binSvg,
  bitcoin: async () => (await import("./bitcoin-BDSOJHM7.js")).bitcoinSvg,
  card: async () => (await import("./card-XI2YRYS4.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-HUTBNOPQ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-TSGS6HWP.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-6ECHUJTC.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-AGGREGJF.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-QRLRVD7Y.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-O5E6C2RC.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-BCBNVLC3.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-HQKWS727.js")).clockSvg,
  close: async () => (await import("./close-QP23CTGV.js")).closeSvg,
  compass: async () => (await import("./compass-PK5EHSLQ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-DED2XEK4.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-GBHNN6DI.js")).copySvg,
  cursor: async () => (await import("./cursor-Z7MAWKID.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-KONONVND.js")).cursorTransparentSvg,
  circle: async () => (await import("./circle-4WU3HXT6.js")).circleSvg,
  desktop: async () => (await import("./desktop-GN4PHKPG.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-OC3WIEEV.js")).disconnectSvg,
  discord: async () => (await import("./discord-UD765L2G.js")).discordSvg,
  ethereum: async () => (await import("./ethereum-4KSF2BPC.js")).ethereumSvg,
  etherscan: async () => (await import("./etherscan-K46WNS7X.js")).etherscanSvg,
  extension: async () => (await import("./extension-U4ADMPUD.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-C5ODGKUP.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-H5B2NLTZ.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-UOW2QKR7.js")).farcasterSvg,
  filters: async () => (await import("./filters-XEOG4LQQ.js")).filtersSvg,
  github: async () => (await import("./github-LHTXRGCX.js")).githubSvg,
  google: async () => (await import("./google-ZT4USAPW.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-3H6ZC2UL.js")).helpCircleSvg,
  image: async () => (await import("./image-E4CU366I.js")).imageSvg,
  id: async () => (await import("./id-PZ3AP5WX.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-LQ4O75G6.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-55LKYVYH.js")).lightbulbSvg,
  mail: async () => (await import("./mail-QJ6PN3BF.js")).mailSvg,
  mobile: async () => (await import("./mobile-MGGYJHZE.js")).mobileSvg,
  more: async () => (await import("./more-25JOKUQ2.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-MYIC6VCM.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-CYU237ZP.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-QAAO2X4M.js")).offSvg,
  playStore: async () => (await import("./play-store-34XWX3FZ.js")).playStoreSvg,
  plus: async () => (await import("./plus-IPJ3XVQH.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-OJM4JLXV.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-PP2DTITJ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-ZYI2SSM3.js")).refreshSvg,
  search: async () => (await import("./search-DUQ4W437.js")).searchSvg,
  send: async () => (await import("./send-KBSVJWBO.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-RHY4MXFI.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-5U6WKZV6.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-NJ6EMW7P.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-MVYVKZLE.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-YQD4FR57.js")).swapVerticalSvg,
  solana: async () => (await import("./solana-UD3EDB4R.js")).solanaSvg,
  telegram: async () => (await import("./telegram-O6VW2R3Y.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-HRW27WHM.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-YEKQ4TRJ.js")).twitchSvg,
  twitter: async () => (await import("./x-JZK6AMAQ.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-7APRR4PN.js")).twitterIconSvg,
  user: async () => (await import("./user-GJS3XZMO.js")).userSvg,
  verify: async () => (await import("./verify-H6RRUJRR.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-VK6QIL5A.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-NYCS5AEH.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-IFVHDQR4.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-IFVHDQR4.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-IFVHDQR4.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-DWFSTU2R.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-CTZRVU7I.js")).warningCircleSvg,
  x: async () => (await import("./x-JZK6AMAQ.js")).xSvg,
  info: async () => (await import("./info-KY5WFTPK.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-R5ON2UZV.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-PQHPPC7W.js")).reownSvg,
  "x-mark": async () => (await import("./x-mark-UYRQQJJO.js")).xMarkSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZYV3QDVL.js.map
